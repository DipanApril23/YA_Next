...
const TAGS = ["AI Solutions", "Web Dev", "SEO", "Automation", "Cloud"];
    ...
    <>
      ...
      <style>{`
        ...
        @keyframes heroAurora2 {
          0%,100% { transform: translate(0,0)     scale(1);    }
          33%      { transform: translate(-5%,4%)  scale(1.10); }
          66%      { transform: translate(4%,-5%)  scale(0.92); }
        }
        @keyframes heroAurora3 {
          0%,100% { transform: translate(0,0)    scale(1);    }
          40%      { transform: translate(7%,3%)  scale(1.06); }
          80%      { transform: translate(-4%,-5%) scale(0.97); }
        }
        ...
        @keyframes heroParticle {
          ...
          50%       { transform: translate(var(--pdx),var(--pdy)) scale(1.6); opacity:0.8; }
        }
        .hero-aurora-1 { animation: heroAurora1 22s ease-in-out infinite; }
        .hero-aurora-2 { animation: heroAurora2 28s ease-in-out infinite; animation-delay:-9s; }
        .hero-aurora-3 { animation: heroAurora3 19s ease-in-out infinite; animation-delay:-15s; }
        .hero-grad-text {
          background: linear-gradient(110deg,#06b6d4,#3b82f6,#a855f7,#ec4899,#06b6d4);
